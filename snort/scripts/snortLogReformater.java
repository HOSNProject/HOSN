...
public class snortLogReformater
{
	...
	public static void main (String[] args)
	{
		...
		try
		{
			...
			while(input.hasNext())
			{
				addToDatabase(formatLine(input.nextLine()));
			}
		}
	...
	public static void addToDatabase(ArrayList<String> formatLine)
	{
		try
		{
			stmt.executeUpdate("insert into logs values(\'"+formatLine.get(0)+"\',\'"+formatLine.get(1)+"\',\'"+formatLine.get(2)+"\',\'"+formatLine.get(3)+"\',\'"+formatLine.get(4)+"\',\'"+formatLine.get(5)+"\',\'"+formatLine.get(6)+"\',\'"+formatLine.get(7)+"\')");
		}
		catch (Exception e)
		{
			System.err.println(e);
